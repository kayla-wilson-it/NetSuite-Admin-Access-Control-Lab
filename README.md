...
### Dashboard
![Dashboard](screenshots/day1_dashboard.png)
- Overview of dashboard widgets, KPIs, and quick links
- Top navigation menu visible

### Customer Record
![Customer](screenshots/day1_customer.png)
...
### Transaction Record
![Transaction](screenshots/day1_transaction.png)
- Shows transaction details (Invoice / Order / Bill)
- Links customer and item information

### Global Search
![Global Search](screenshots/day1_global_search.png)
...
![Dashboard Role 2](screenshots/day2_role_dashboard2.png)
...
![User Roles](screenshots/day2_user_role_assignment.png)
